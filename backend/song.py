class Song():
    def __init__(self, id_: str, title: str, artist_name: str = None, album_name: str = None, popularity: int = 0, artist_id: str = None, album_id: str = None, clean_title: str = None):
        self.id = id_
        self.title = title
